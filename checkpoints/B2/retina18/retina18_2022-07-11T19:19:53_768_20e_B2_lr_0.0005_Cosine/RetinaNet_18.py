...
log_level = 'INFO'
load_from = 'checkpoints/B2/retina18/retina18_2022-07-11T16:22:13_768_20e_B2_lr_0.0005_Cosine/epoch_17.pth'
resume_from = None
...
model = dict(
    ...
    test_cfg=dict(
        ...
        max_per_img=100))
work_dir = 'checkpoints/B2/retina18/retina18_2022-07-11T19:19:53_768_20e_B2_lr_0.0005_Cosine'
auto_resume = True
gpu_ids = range(0, 1)
