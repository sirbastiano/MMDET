...
log_level = 'INFO'
load_from = 'checkpoints/B2/htc50/htc50_2022-07-19T01:23:01_768_50e_B2_lr_0.001_step/epoch_23.pth'
resume_from = None
...
model = dict(
    ...
    test_cfg=dict(
        ...
        rcnn=dict(
            ...
            max_per_img=100,
            mask_thr_binary=0.5)))
work_dir = 'checkpoints/B2/htc50/htc50_2022-07-19T17:32:54_768_50e_B2_lr_0.0005_step'
auto_resume = True
gpu_ids = range(0, 1)
