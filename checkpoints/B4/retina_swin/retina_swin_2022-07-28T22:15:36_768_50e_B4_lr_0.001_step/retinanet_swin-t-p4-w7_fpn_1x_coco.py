...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        classes=('wake', ),
        ann_file='data/DATASETS/B4/annotations/instances_train2017.json',
        img_prefix='data/DATASETS/B4/train2017/',
        pipeline=[
            dict(type='LoadImageFromFile', color_type='color'),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(type='Resize', img_scale=[(768, 768)], keep_ratio=False),
    ...
    val=dict(
        type='CocoDataset',
        classes=('wake', ),
        ann_file='data/DATASETS/B4/annotations/instances_val2017.json',
        img_prefix='data/DATASETS/B4/val2017/',
        pipeline=[
            dict(type='LoadImageFromFile', color_type='color'),
            dict(type='Resize', img_scale=[(768, 768)], keep_ratio=False),
            dict(
...
model = dict(
    ...
    test_cfg=dict(
        ...
        max_per_img=100))
work_dir = 'checkpoints/B4/retina_swin/retina_swin_2022-07-28T22:15:36_768_50e_B4_lr_0.001_step'
